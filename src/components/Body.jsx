...
const Body = () => {
    ...
    return (
        <div className="main my-2 mx-[calc(10%+36px)] min-h-screen">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-700 woym_heading font-txtFont font-md">
                What's on your mind?
            </h2>
            ...
            <h2 className="mb-4 text-2xl font-semibold mt-14 text-slate-700 restaurantChainHeading font-txtFont">
                Top restaurant chains in {district}
            </h2>
            <div className="flex flex-wrap items-center mb-3">
                <div className="w-2/3  h-[45px] ml-4 flex rounded-md items-center shadow-md md:w-1/2 lg:w-1/4">
                    <input
                        type="text"
                    ...
                    />
                    <button
                        className="searchBtn h-[45px] ml-2 flex justify-center items-center border border-none text-slate-700 rounded-r-md px-5 active:scale-y-105 duration-200"
                        onClick={() => {
                    ...
                    >
                        <IoSearch className="p-1 duration-200 ease-in-out rounded-full text-slate-400 hover:text-slate-600 size-9 hover:bg-slate-200 hover:scale-110" />
                    </button>
                </div>
            </div>
                ...
                >
                    {isTopRated ? (
                        <span className="flex items-center">
                            Top Rated <MdClose className="ml-2" />
                        </span>
                    ) : (
                        "Top Rated"
                    )}
