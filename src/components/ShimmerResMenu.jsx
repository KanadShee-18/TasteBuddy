...
const ShimmerResMenu = () => {
    return (
        <div className="w-4/5 min-h-screen m-auto md:w-3/4 lg:w-1/2">
            <div className="shimmer-heading flex justify-start md:w-[500px] w-[250px] h-[45px] bg-gradient-to-r from-slate-600 via-slate-300 to-slate-100 rounded-md my-4"></div>
            ...
            <div className="mt-10">
                <div className="shimmer-heading flex flex-wrap justify-evenly md:w-[500px] w-[250px] h-[45px] bg-gradient-to-r from-slate-600 via-slate-300 to-slate-100 rounded-md my-4"></div>
                {Array(4)
                    .fill("")
                    .map((_, index) => (
            ...
            <div className="shimmer-heading flex justify-start md:w-[500px] w-[250px] h-[45px] bg-slate-600 rounded-md my-4"></div>
