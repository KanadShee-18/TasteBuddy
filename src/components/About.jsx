...
const About = () => {
  return (
    <div className="min-h-screen">
      <div className="h-auto md:w-1/2 mb-[200px] w-3/4 py-3 mx-auto mt-[40px] bg-slate-200 text-md text-yellow-100 justify-center items-center text-center rounded-md shadow-xl ease-out hover:scale-105 duration-200">
